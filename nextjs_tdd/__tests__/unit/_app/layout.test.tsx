...
describe('RootLayout', () => {
    test('should render children, home, and airlines properly', async () => {
        const mockProps = {
        ...
        const childrenProp = await screen.findByText(mockChildrenProps.children)
        const homeProp = await screen.findByText(mockChildrenProps.home)
        const airlinesProp = await screen.findByText(mockChildrenProps.airlines)
